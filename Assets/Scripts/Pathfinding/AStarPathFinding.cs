...
public class AStarPathfinding : MonoBehaviour
{
    ...
    private void Update()
    {
        if (Input.GetKeyDown(KeyCode.Space) && startTransform != null && targetTransform != null)
        {
    ...
    public List<Node> FindPath(Vector3 startPos, Vector3 targetPos)
    {
        ...
        Node targetNode = pathGrid.GetNodeFromWorldPosition(targetPos);
    ...
    public void SetTransform(Transform start, Transform target)
    {
